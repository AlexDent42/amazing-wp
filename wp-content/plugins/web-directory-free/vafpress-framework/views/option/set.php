<div class="wrap">
	...
	<div id="vp-wrap" class="vp-wrap">
		...
		<div id="vp-copyright" class="vp-copyright">
			<p><?php printf(__('This option panel is built using <a href="http://vafpress.com/vafpress-framework">Vafpress Framework %s</a> powered by <a href="http://vafpress.com">Vafpress</a>', 'vp_w2dc_textdomain'), VP_W2DC_VERSION); ?></p>
		</div>
	</div>
