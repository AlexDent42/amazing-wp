...
*/
VP_W2DC_AutoLoader::add_namespaces(VP_W2DC_NAMESPACE);
VP_W2DC_AutoLoader::add_directories(VP_W2DC_CLASSES_DIR, VP_W2DC_NAMESPACE);
VP_W2DC_AutoLoader::register();

class VP_W2DC_AutoLoader
{

	/**
	 * Indicates if VP_W2DC_AutoLoader has been registered.
	 * 
	 * @var boolean
	 */
	...
	public static function register()
	{
		...
		{
			spl_autoload_register(array('VP_W2DC_AutoLoader', 'load'));
		}
