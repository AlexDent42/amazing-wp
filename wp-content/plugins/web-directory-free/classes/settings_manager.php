							...
							'controls' => array(
								'search' => array(
									...
									'fields' => array(
										...
										array(
											'type' => 'toggle',
											'name' => 'w2dc_hide_search_button',
											'label' => __('Hide search button on the form', 'W2DC'),
											'description' => esc_html__('When hidden - the search will auto-submit', 'W2DC'),
											'default' => get_option('w2dc_hide_search_button'),
										),
										array(
											'type' => 'toggle',
											'name' => 'w2dc_auto_scroll_on_search',
											'label' => __('Auto-scroll to listings', 'W2DC'),
											'default' => get_option('w2dc_auto_scroll_on_search'),
										),
										array(
											'type' => 'toggle',
										...
										array(
											...
											'description' => __('This setting is actual for search form, search widget and locations menus', 'W2DC'),
										...
										array(
											...
											'description' => __('This setting is actual for search form, search widget and categories menus', 'W2DC'),
									...
									'fields' => array(
										...
										array(
											...
											'label' => esc_html__('jQuery UI Style', 'W2DC'),
									 		'description' =>  esc_html__('Controls the color of calendar, dialogs and slider UI widgets', 'W2DC') . (get_option('w2dc_notinclude_jqueryui_css') ? ' <strong>' . esc_html__('Warning: You have enabled not to include jQuery UI CSS on Advanced settings tab. Selected style will not be applied.', 'W2DC') . '</strong>' : ''),
									 		'items' => array(
									 			array(
									 				'value' => 'blitzer',
									 				'label' => 'Blitzer',
