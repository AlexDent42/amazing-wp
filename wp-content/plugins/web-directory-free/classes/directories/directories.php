...
class w2dc_directory {
	...
	public function __construct() {
		$this->listing_slug = get_option('w2dc_listing_slug');
		$this->category_slug = get_option('w2dc_category_slug');
		$this->location_slug = get_option('w2dc_location_slug');
		$this->tag_slug = get_option('w2dc_tag_slug');
	}
	...
	public function buildDirectoryFromArray($array) {
		...
		$this->listing_slug = w2dc_getValue($array, 'listing_slug');
		$this->category_slug = w2dc_getValue($array, 'category_slug');
		$this->location_slug = w2dc_getValue($array, 'location_slug');
		$this->tag_slug = w2dc_getValue($array, 'tag_slug');
