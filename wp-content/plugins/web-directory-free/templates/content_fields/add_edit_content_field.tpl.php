		...
		<tbody>
			...
			<script>
				(function($) {
					...
					$(function() {
						...
						$('body').on('click', "#on_search_form", function() {
							if ($(this).is(':checked'))
			...
			<tr class="can_be_searched_block" <?php if (!$content_field->canBeSearched()): ?>style="display: none;"<?php endif; ?>>
				...
				<td>
					...
					<p class="description"><?php _e("If you choose specific categories below, this field will be shown only when any of these categories selected in a search form.", 'W2DC'); ?></p>
				</td>
			</tr>
			<tr class="can_be_searched_block" <?php if (!$content_field->canBeSearched()): ?>style="display: none;"<?php endif; ?>>
				<th scope="row">
				...
				<td>
					...
					<p class="description"><?php _e("It is in Less/More filters section.", 'W2DC'); ?></p>
				</td>
			</tr>
