...
<script>
	(function($) {
		...
		$(function() {
			...
			<?php endif; ?>
			$('body').on('click', "#reset_date_max_<?php echo $settings['field_id']; ?>", function() {
...
<input type="button" id="reset_date_max_<?php echo $settings['field_id']; ?>" value="<?php esc_attr_e('reset', 'W2DC')?>" />