	<div class="w2dc-row w2dc-form-group">
		...
		<div class="w2dc-form-group w2dc-col-md-12">
			...
			<div class="w2dc-radio">
				<label>
					<input type="radio" name="daddr" class="w2dc-select-directions-<?php echo $map_id; ?>" <?php checked($i, 1); ?> value="<?php esc_attr_e($location->map_coords_1.' '.$location->map_coords_2); ?>" />
					<?php 
		...
		<div class="w2dc-form-group w2dc-col-md-12">
			<div id="w2dc-route-container-<?php echo $map_id; ?>" class="w2dc-route-container w2dc-maps-direction-route"></div>
		</div>
