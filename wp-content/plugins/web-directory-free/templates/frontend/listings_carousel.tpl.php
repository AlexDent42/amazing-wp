		<div class="w2dc-content w2dc-listings-carousel-wrapper" id="w2dc-controller-<?php echo $frontend_controller->hash; ?>" data-controller-hash="<?php echo $frontend_controller->hash; ?>">
			<style type="text/css">
