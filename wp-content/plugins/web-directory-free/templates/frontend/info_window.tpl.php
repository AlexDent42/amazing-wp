<div class="w2dc-map-info-window">
	<div class="w2dc-map-info-window-title">
		...
		<span class="w2dc-close-info-window w2dc-fa w2dc-fa-close" onclick="w2dc_infoWindows[&quot;<?php echo esc_attr($map_id); ?>&quot;].close();"></span>
		<?php elseif (w2dc_getMapEngine() == 'mapbox'): ?>
		<span class="w2dc-close-info-window w2dc-fa w2dc-fa-close" onclick="w2dc_infoWindows[&quot;<?php echo esc_attr($map_id); ?>&quot;].remove();"></span>
		<?php endif; ?>
	</div>
	<?php if ($logo_image): ?>
	<div class="w2dc-map-info-window-logo" style="width: <?php echo get_option('w2dc_map_infowindow_logo_width')+10; ?>px">
		<?php if ($listing->level->listings_own_page): ?>
